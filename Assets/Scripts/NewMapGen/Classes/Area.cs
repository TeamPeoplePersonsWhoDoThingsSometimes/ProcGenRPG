...
public class Area
{
    ...
    public void showArea()
    {
        ...
        //Should first ensure that this area has been generated. If not, do the generation now.
        ...
        for (int i = 0; i < tiles.GetLength(0); i++)
        {
            for (int j = 0; j < tiles.GetLength(1); j++)
            {
                if (tiles[i,j] != null)
                {
                    ...
                    current.GetComponent<SpriteRenderer>().sprite = LoadResources.instance.fourWay;
